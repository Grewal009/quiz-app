const FinishedScreen = (prop) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-xl font-semibold">
      <p className="my-1 w-full cursor-pointer rounded-2xl bg-cyan-500 px-4 py-2 text-center text-zinc-50">
        {emoji} Your score <strong>{points}</strong> out of{" "}
        {numOfQuestions * 10}
      </p>
      <p className="text-base text-gray-600">High score: {highScore}</p>
      <button
